...
class TransporterPickUpSigningView extends ConsumerStatefulWidget {
  const TransporterPickUpSigningView({
  ...
  @override
  TransporterPickUpSigningState createState() =>
      TransporterPickUpSigningState();
}

class TransporterPickUpSigningState
    extends ConsumerState<TransporterPickUpSigningView> {
                ...
                return AppButton.primary(
                  onPressed: () async {
                    ...
                    await context.pushNamed(
                      AppRoute.transporterConfirmSignature.name,
                      extra: SignExtra(
